...
export default function ReportWizard() {
  ...
  async function handleCapture() {
    ...
    try {
      // Kick off reverse geocode in parallel with incident creation
      const geocodePromise = fetch(
        `https://nominatim.openstreetmap.org/reverse?lat=${location.lat}&lon=${location.lng}&format=json`,
        { headers: { 'Accept-Language': 'en', 'User-Agent': 'rescure-app' } }
      )
        .then((r) => r.json())
        .catch(() => null)
      ...
      // Pre-fill location fields from reverse geocode (user can edit)
          ...
          <form onSubmit={handleSubmit(onReviewSubmit)} className="space-y-6">
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm border border-gray-100 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  placeholder="Describe the animal condition, injuries, and any surrounding dangers…"
                  rows={4}
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm border border-gray-100 space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-green-600 font-medium">Auto-filled · edit if needed</span>
              </div>
